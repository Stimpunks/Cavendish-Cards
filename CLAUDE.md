...
- **Generated + gitignored** (Netlify rebuilds — commit the *source*, not these): `web/cards.json`, `web/guidebook.html`, `web/implementation.html`, `web/why.html`, `web/origin.html`, `web/arles.html`, `web/example-spreads.html`, `web/facilitator.html`, `web/404.html`, `web/faces/`.
