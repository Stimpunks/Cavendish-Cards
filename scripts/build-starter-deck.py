...
REALMS = [
    ...
    ("love-locution", "Love Locutions",
     "Affirmations. Given to someone, or claimed for yourself — never earned, "
     "never a reward for behaving. A distinct card back marks them as "
     "affirmations, held or given, rather than a state or a need. If a Kind word "
     "is ever treated as a prize, that's scoring — they are never earned."),
...
- **Image cue** — a motif for the illustrator. All deck art is human- and community-made; these are starting points, not finished art. Until a human piece arrives, each card carries a placeholder vector illustration drawn from its cue, replaced automatically the moment human art arrives.
...
Every realm carries a **draw-your-own** card, and the deck ships with spare blanks besides — a blank front with the realm colors down one edge so it can join any realm. A person or a staff member draws the need the deck doesn't have yet. This is the sketch-based play from the brief, and it is how the community authors the deck: use it, find the gap, draw the card, send it in.

| Name          | Image cue                 | Prompt                                   |
| ------------- | ------------------------- | ---------------------------------------- |
| draw your own | a blank card and a pencil | The deck isn't finished. What's missing? |"""

BACKS = """## Three card backs
