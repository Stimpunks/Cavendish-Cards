...
> - Art is human- and community-made. The image cue is a motif for an illustrator, not finished art — don't paste AI-generated images. Until a human piece arrives, the card carries a hand-written vector placeholder from `scripts/card-art.py`; add a motif there when you add a card.
