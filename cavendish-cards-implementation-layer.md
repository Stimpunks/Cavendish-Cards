...
- **Choosing** — Cut the field down. Too many options is a real cost, not fussiness — offer two or three instead of ten, settle the small things in advance, or hand over a first step to start from. Narrowing a choice is not taking the choice away.
...
- **Same & new** — Two directions on one dial. Hold the routine steady where it does not need to move — same order, same setup, same cup — and change what is inside it when it has gone flat. A person can want both at once, and usually does: a steady container with moving contents is the shape that works, not a contradiction.
