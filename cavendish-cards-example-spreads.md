# Cavendish Cards — Example Spreads
...
1. **What's turned up?** Only the face-up cards count. What's face-down is private.
2. **What is it naming?** Say it back in the person's own frame — the feeling, the state, the need — never as a fault.
3. **What does the room do?** Turn the reading into changes to the environment. That is the whole point.

----

## 1. First week in a new, loud classroom
...
## 2. Stuck at the door to lunch (early years)

**Turned up:** *stuck · i need a minute · a snack or a drink*

**Reading it:** this isn't refusing or dawdling — the engine won't start yet, and there's a body need underneath. So stop the clock, let the minute be a minute, and meet the snack without making it a deal. The move to lunch happens *after* the pause, not instead of it.

*One spread, one day. A short, simple hand is a full and valid spread — a spread can be a single card. (Play mode: show me / build my day.)*

## 3. Planning a day with a support worker

**Turned up, across the day:** *warm (morning) · in the zone (project time) · pulled every way (afternoon) · let me finish · a den*

**Reading it:** mornings are settled — protect that. The deep-focus stretch is a strength, so guard it and give warning before it ends (*let me finish*). The afternoon is where too many things pile up, so that is where to take things away, and where the *den* goes. Build the day around the good weather and the deep focus, not against them.

*One spread, one day. This is a plan the person made with someone, not a fixed timetable. (Play mode: build my day / moving between.)*

## 4. A whole class lays its weather
...
**Reading it:** this is a niche-construction brief in the person's own hand. Friction is high, so soften it: fix the temperature, lower the lights, cut the sound, and give a claimed base to work from. The last card matters most — *let me control it* — because the same light or sound is often fine when the person holds the dial, and too much when someone else sets it. Hand over the controls.

*One spread, one day — but this kind of map is worth keeping and coming back to. (Play mode: map the edges / build a niche.)*

## 6. Moving through a day, on my own rhythm

**Turned up, in a row:** *the cave · not right now → the campfire · people i know → the watering hole · come say hi → the cave · i need a minute*

**Reading it:** laid left to right, this is a rhythm, not a contradiction. The person starts solo and closed off, warms to a small known group, opens to the easy edge of the crowd, then heads back to the cave. That is intermittent collaboration — everyone needs alone time, small-group time, and open time, but not all at once and not in the same measure. So let the coming and going cost nothing: no explaining, no earning your way back in.
